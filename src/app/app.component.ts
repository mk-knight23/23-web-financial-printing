...
@Component({
  ...
  template: `
    <div
      ...
      [class.light]="!settingsService.isDarkMode()"
    >
      <!-- Top Navigation -->
      <nav
        class="bg-white dark:bg-financial-800 border-b border-financial-200 dark:border-financial-700 px-6 py-4 flex justify-between items-center shadow-sm"
      >
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-12 items-start">
          ...
          <div class="xl:col-span-4 space-y-8">
            <div class="space-y-2">
              ...
              <p class="text-financial-500 dark:text-financial-400">
                Fill in the details to generate your professional bank cheque.
              </p>
            </div>
            ...
            <!-- Security Notice -->
            <div
              class="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl border border-emerald-100 dark:border-emerald-800 flex space-x-3"
            >
              <span class="text-emerald-500">🛡️</span>
              <p class="text-[10px] text-emerald-700 dark:text-emerald-400 font-medium">
                This is a generation tool for documentation and organizational purposes. Always
                verify with your bank's actual security standards.
              </p>
            </div>
          </div>
          ...
          <div class="xl:col-span-8 flex flex-col items-center">
            <div class="sticky top-12 space-y-8 w-full flex flex-col items-center">
              <div class="text-center space-y-1">
                <span class="text-[10px] font-black uppercase tracking-[0.2em] text-accent-primary"
                  >Live Preview</span
                >
              ...
              <div class="w-full overflow-x-auto pb-8 custom-scrollbar flex justify-center">
                <app-live-preview
                  class="scale-75 md:scale-90 lg:scale-100 origin-top"
                ></app-live-preview>
              </div>
            </div>
          </div>
  ...
  styles: [
    `
      ...
      .custom-scrollbar::-webkit-scrollbar-thumb {
        @apply bg-financial-200 dark:bg-financial-700 rounded-full;
      }
    `,
  ],
})
