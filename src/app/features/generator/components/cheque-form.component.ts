  ...
  template: `
    <div class="space-y-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="space-y-2">
          <label class="text-sm font-bold text-financial-500 uppercase tracking-wider"
            >Select Bank</label
          >
          <select
      ...
      <div class="space-y-2">
        ...
        >
        <div class="relative">
          <span class="absolute left-4 top-1/2 -translate-y-1/2 font-bold text-financial-400"
            >₹</span
          >
          <input
            type="number"
      ...
      <div class="space-y-2">
        ...
        >
        <div
          class="p-3 bg-financial-100 dark:bg-financial-800 rounded-lg text-sm font-medium italic min-h-[48px]"
        >
