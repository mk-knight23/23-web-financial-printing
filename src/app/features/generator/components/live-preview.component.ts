  ...
  template: `
    <div class="flex flex-col items-center space-y-8">
      ...
      >
        ...
        <!-- Date Field -->
        <div
          class="absolute border-2 border-financial-200 p-1 flex space-x-1"
          [style.left.px]="template().fields.date.x"
          [style.top.px]="template().fields.date.y"
        >
          @for (char of formatDate(cheque().date); track $index) {
            <span
              class="w-6 h-8 flex items-center justify-center border border-financial-100 font-cheque font-bold text-lg"
            >
              {{ char }}
            </span>
          }
        ...
        <!-- Payee -->
        <div
          class="absolute w-[500px] border-b border-financial-300 pb-1"
        ...
        <!-- Amount Words -->
        <div
          class="absolute w-[500px] leading-8"
        ...
        >
          ...
          <span
            class="font-cheque text-sm uppercase block border-b border-financial-300 min-h-[32px]"
          >
        ...
        <!-- Amount Box -->
        <div
          class="absolute border-2 border-financial-400 bg-financial-50/50 p-2 flex items-center space-x-2"
        ...
        >
          ...
          <span
            class="font-cheque text-lg tracking-widest border border-financial-200 px-2 py-1 bg-white"
          >
        ...
        <!-- MICR Code Mock -->
        <div
          class="absolute bottom-4 left-1/2 -translate-x-1/2 font-cheque text-lg tracking-[1em] opacity-40"
        >
...
export class LivePreviewComponent {
  ...
  async downloadPDF() {
    ...
    doc.text(
      `RUPEES: ${this.chequeService.amountInWords()}`,
      t.fields.amountWords.x,
      t.fields.amountWords.y,
    );
